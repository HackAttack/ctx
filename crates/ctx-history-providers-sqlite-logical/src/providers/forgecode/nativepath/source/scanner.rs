...
impl ForgeCodeScanner {
    pub(in crate::providers::forgecode) fn new(
    ...
    #[cfg(test)]
    pub(in crate::providers::forgecode) fn next_page(&mut self) -> Result<Option<ForgeCodePage>> {
    ...
    pub(in crate::providers::forgecode) fn stream_pages(
        &mut self,
    ...
    pub(in crate::providers::forgecode) fn decoded_rows(&self) -> u64 {
        self.decoded_rows
    }

    pub(in crate::providers::forgecode) fn source_database(&self) -> &ForgeCodeSqliteDatabase {
