...
pub use upgrade::{
    ...
    is_valid_install_attempt_id, is_valid_upgrade_attempt_id, managed_install_executable,
    managed_install_marker_for_current_exe, read_state_json, run_hosted_transaction,
    terminal_installation_upgrade_attempt_id, upgrade_diagnostics, AutomaticUpgradeObservation,
    AutomaticUpgradePolicyProvider, AutomaticUpgradePolicySnapshot, DaemonRestart,
    DaemonUpgradeLease, DaemonUpgradePort, HostedTransactionAction, HostedTransactionArgs,
    InstallMarker, ManagedInstallDiagnostic, ManagedInstallMarker, PreparedDaemonUpgrade,
    ProductBuildIdentity, ReleaseProcessPort, ReleaseTransport, SemanticAccelerator,
    SemanticLayoutPort, SemanticModelContract, SemanticModelVariant, UpgradeDiagnostics,
    UpgradeEngine, UpgradeFailureKind, UpgradeObserver, UpgradeOutcome, UpgradePlan, UpgradePolicy,
    UpgradeTerminalStatus, STATE_SCHEMA_VERSION,
};
