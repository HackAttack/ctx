...
use crate::{compact_json, ProCatchUpPort};
use crate::{
    paths_status::{create_private_dir_all, secure_private_file_permissions},
...
pub struct HelperRecheckSchedule {
    pub attempt_key: String,
    pub target_ready: bool,
}

pub fn publish(data_root: &Path, target_helper_sha256: &str) -> Result<()> {
...
pub fn schedule<P: ProCatchUpPort + ?Sized>(
    ...
    let installed = pro.selected_helper_artifact_sha256(data_root)?;
