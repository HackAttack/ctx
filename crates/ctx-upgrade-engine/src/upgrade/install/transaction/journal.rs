...
fn validate_paths(
    ...
    validate_paths_for_platform(
        journal,
        super::super::super::platform_key()?,
        semantic_layout,
    )
}

fn validate_paths_for_platform(
    journal: &InstallTransactionJournal,
    platform: &str,
    semantic_layout: &dyn SemanticLayoutPort,
) -> Result<()> {
    ...
    if semantic.is_empty() {
        ...
        semantic::validate_paths(semantic_layout, journal, &semantic, platform)?;
    }
...
pub(super) fn validate_paths_for_platform_for_test(
    ...
    validate_paths_for_platform(
        journal,
        platform,
        &super::super::super::TEST_SEMANTIC_LAYOUT,
    )
}
