...
pub use certification::{
    certify_activated_generation, load_certified_physical_integrity,
    reclaim_unreferenced_certifications, reclaim_unreferenced_certifications_with_fence,
    refresh_certification_after_managed_reclamation, scrub_and_certify_physical_integrity,
...
pub use clone::{
    ...
    CandidateActivationFence, CandidateOwnershipFence, RepublishCandidate,
};
#[cfg(all(
...
pub use generation::{
    ...
    reclaim_inactive_generation_directories_with_fence, slot_path, sync_directory, sync_generation,
    ActiveGenerationPointer, CandidateGeneration, GenerationSlot, PointerPublicationOutcome,
};
#[cfg(any(test, feature = "test-support"))]
pub use generation::{ReclamationStage, ReclamationTestHookGuard};
pub use identity::{hex, is_generation_id, sha256_hex};
pub use lock::{
    acquire_generation_ownership_fence, acquire_generation_writer_lock_with_retry,
    GenerationOwnershipFence,
};
pub use manifest::{
    load_manifest_bytes, reclaim_unreferenced_manifests, reclaim_unreferenced_manifests_with_fence,
...
pub use retention::{
    ...
    release_generation_retention_lease, GenerationReadLease, GenerationReadLeaseAcquisition,
    GenerationRetentionLease,
};
...
pub const GENERATION_OWNERSHIP_LOCK_FILE: &str = ".ctx-generation-ownership.lock";
