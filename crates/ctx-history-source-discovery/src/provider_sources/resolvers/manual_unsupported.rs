...
pub(super) fn resolve(
    ...
    match spec.provider {
        CaptureProvider::Qoder => resolve_qoder(probes, context, spec),
        CaptureProvider::Firebender => resolve_firebender(probes, context, spec),
        CaptureProvider::Auggie => resolve_auggie(probes, context, spec),
        CaptureProvider::DeepAgents => resolve_deepagents(probes, context, spec),
        CaptureProvider::Mux => resolve_mux(probes, context, spec),
        CaptureProvider::Cline => resolve_cline(probes, context, spec),
