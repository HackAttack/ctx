...
use crate::{
    ...
    CaptureError, SelectedSqliteCaptureBinding,
};
...
pub(super) const DIRECT_PARSER_REVISION: &str =
    "firebender-source-backed-v6-closed-facts-agent-scope";
...
impl<B: SelectedSqliteCaptureBinding> ReplacementDocumentTree for FirebenderDocumentTreeAdapter<B> {
