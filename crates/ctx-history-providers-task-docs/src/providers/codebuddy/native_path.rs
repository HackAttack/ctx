...
use crate::{
    ...
    provider_safe_path_segment, CaptureError, ProviderAdapterContext, Result,
...
#[path = "native_path/discovery.rs"]
mod discovery;
#[path = "native_path/parsing.rs"]
mod parsing;
#[path = "native_path/projection.rs"]
mod projection;
...
use parsing::*;
use projection::*;
pub use source_backed::CodeBuddyDocumentAdapter;
