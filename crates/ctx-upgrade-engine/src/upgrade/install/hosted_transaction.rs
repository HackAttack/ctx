...
pub enum HostedTransactionAction {
    Install,
    UninstallPrepare,
    UninstallArm,
    UninstallCommit,
...
pub struct HostedTransactionArgs {
    pub action: HostedTransactionAction,
...
pub fn hosted_uninstall_is_active_for_executable(executable_path: &Path) -> Result<bool> {
