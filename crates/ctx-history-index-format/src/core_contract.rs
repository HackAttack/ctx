...
pub fn current_core_record_contract_fingerprint() -> String {
    ctx_history_core::core_record_contract_fingerprint()
}

/// Accepts only the Core contract emitted by this build.
pub fn validate_core_contract_fingerprint(actual: &str) -> Result<()> {
...
pub fn expected_source_generation_policy_hash() -> Result<String> {
