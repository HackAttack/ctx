...
#[allow(dead_code)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum ProLifecycleOperationV1 {
    Setup,
    Manage,
    Status,
    Uninstall,
...
impl ProAccessStateV1 {
    pub fn from_safe_name(value: &str) -> Option<Self> {
        match value {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum ProHelperConnectionOutcomeV1 {
    NotAttempted,
    Connected,
    NotInstalled,
    AuthorizationFailed,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum ProReconcileOutcomeV1 {
    NotAttempted,
    Missing,
    Current,
    Installed,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum ProMaterializationModeV1 {
    NoOp,
    Full,
    Incremental,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum ProMaterializationResultV1 {
    Completed,
    Failed,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum ProUninstallDataDispositionV1 {
    Delete,
    Preserve,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct ProMaterializationTelemetryV1 {
    pub mode: Option<ProMaterializationModeV1>,
    pub commit: ProCommitOutcomeV1,
    pub freshness: ProFreshnessV1,
    pub result: ProMaterializationResultV1,
    pub batches: Option<CountBucket>,
    pub input_records: Option<CountBucket>,
    pub output_records: Option<CountBucket>,
    pub lag: Option<CountBucket>,
    pub helper_connection: ProHelperConnectionOutcomeV1,
    pub failure: Option<ProFailureBucketV1>,
}
...
impl ProMaterializationTelemetryV1 {
    ...
    pub fn fail(&mut self, code: Option<&str>) {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct ProLifecycleTelemetryV1 {
    pub operation: ProLifecycleOperationV1,
    pub access_state: Option<ProAccessStateV1>,
    pub helper_connection: ProHelperConnectionOutcomeV1,
    pub reconcile: ProReconcileOutcomeV1,
    pub uninstall_data: Option<ProUninstallDataDispositionV1>,
    pub materialization: Option<ProMaterializationTelemetryV1>,
    pub failure: Option<ProFailureBucketV1>,
}

impl ProLifecycleTelemetryV1 {
    pub fn new(operation: ProLifecycleOperationV1) -> Self {
        Self {
            operation,
            access_state: None,
            helper_connection: ProHelperConnectionOutcomeV1::NotAttempted,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct ProStatusTelemetryV1 {
    pub surface: ProSurfaceV1,
    pub access_state: Option<ProAccessStateV1>,
    pub helper_connection: ProHelperConnectionOutcomeV1,
    pub failure: Option<ProFailureBucketV1>,
}
...
impl ProStatusTelemetryV1 {
    pub fn new(surface: ProSurfaceV1) -> Self {
        Self {
            surface,
            access_state: None,
            helper_connection: ProHelperConnectionOutcomeV1::NotAttempted,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct ProBlameTelemetryV1 {
    pub target: Option<ProBlameTargetV1>,
    pub surface: ProSurfaceV1,
...
impl ProBlameTelemetryV1 {
    pub fn new(target: Option<ProBlameTargetV1>, surface: ProSurfaceV1) -> Self {
        Self {
            target,
            surface,
            result_count: None,
    ...
    pub fn complete(&mut self, result_count: usize, has_more: bool) {
...
pub fn pro_failure_bucket(code: Option<&str>) -> ProFailureBucketV1 {
    match code {
...
pub fn pro_helper_connection_outcome(code: Option<&str>) -> ProHelperConnectionOutcomeV1 {
    match code {
