...
#[derive(Debug, Clone)]
pub struct PathDiagnosticEntry {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum BackgroundApplyBlockReason {
    PathShadowed,
    ManagedExecutableNotOnPath,
    ManagedExecutableUnavailable,
}
...
impl PathDiagnostics {
    ...
    pub fn background_apply_block_reason(&self) -> Option<BackgroundApplyBlockReason> {
    ...
    pub fn entries(&self) -> &[PathDiagnosticEntry] {
        &self.entries
    }
    ...
    pub fn resolver_status(&self) -> PathResolverStatus {
        self.resolver_status
    }
}

impl PathDiagnosticEntry {
...
pub fn path_diagnostics(current_exe: &Path, current_version: &str) -> PathDiagnostics {
...
mod tests {
    ...
    fn path_shadow_and_winner_have_machine_readable_apply_status() {
        ...
        assert_eq!(diagnostics.resolver_status(), PathResolverStatus::Shadowed);
