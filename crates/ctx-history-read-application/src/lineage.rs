...
use ctx_history_index_query::{CopiedEventLineage, CopiedEventLineageResolution};
use serde_json::{json, Map, Value};

const COPIED_LINEAGE_MAX_BYTES: usize = 64 * 1024;

pub fn copied_lineage_read_model(lineage: &CopiedEventLineage) -> Result<Value> {
...
pub fn copied_lineage_summary(value: &Value) -> Option<(&Value, u64, Option<&str>, u64)> {
    let lineage = value
        .get("copied_lineage")
...
pub fn copied_lineage_relationship_summary(lineage: &Value) -> Option<String> {
