...
impl LingmaDatabaseCatalogLineage {
    pub fn typed_key(&self) -> Result<TypedKey, LingmaDiscoveryUnavailable> {
...
impl LingmaInventorySelector {
    ...
    pub fn observe(&self) -> Result<LingmaDiscoveredInventory, LingmaDiscoveryUnavailable> {
        discover_lingma_inventory_with_authority(&self.probes, &self.context)
    }
}
...
pub fn resolve_lingma_discovery_authority(
    ...
    discover_lingma_inventory_with_authority(probes, context)?
        .databases
        .into_iter()
...
mod tests {
    ...
    fn vscode_inventory_retains_client_and_profile_catalog_lineage() {
        ...
        let inventory =
            LingmaInventorySelector::new(context, crate::provider_sources::TEST_PROVIDER_PROBES)
                .observe()
                .unwrap();
