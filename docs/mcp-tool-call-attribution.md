...
Capability revision 4 evaluates all 42 providers across 44 base routes and 47
...
- Codex `codex_session_jsonl_tree` / `codex-nativepath-jsonl-v0`, parser
  `codex-nativepath-core-activity-v6-command-output-retrieval-exclusion`, for unversioned producer
...
The 43 `not-qualified` rows do not mean their providers are unsupported. They
