...
pub use provider::source_backed::{
    ...
    source_backed_source_failure_identity, BorrowedIndexManifestView, CommittedIndexManifestView,
    CrushProjectDatabaseV0, CrushProjectInventoryObservationV0, CrushProjectInventorySourceV0,
    IndexCaptureCommitReceipt, IndexCaptureVerifiedPin, IndexManifestView, IndexVerifiedCapture,
    RouteObservation, SourceBackedAutomaticRegistryBuild, SourceBackedAutomaticRegistryIssue,
