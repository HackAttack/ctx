...
impl From<ctx_history_source_io::SourceIoError> for KiroSourceBackedErrorV0 {
    fn from(error: ctx_history_source_io::SourceIoError) -> Self {
        Self::Capture(error.into())
    }
}

impl From<ctx_history_source_sqlite::SqliteIoError> for KiroSourceBackedErrorV0 {
