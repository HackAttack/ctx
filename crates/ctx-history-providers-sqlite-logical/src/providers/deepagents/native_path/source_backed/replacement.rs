...
pub struct DeepAgentsTreeAuthority {
...
impl<B: crate::LogicalSqliteRuntimeBinding> ReplacementDocumentTree for DeepAgentsRouteAdapter<B> {
    ...
    fn discover_complete(
        ...
        if fs::symlink_metadata(self.selection.path()).is_err() {
