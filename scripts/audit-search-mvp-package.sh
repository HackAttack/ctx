...
if grep_files 'work-[r]ecord-(publish|report|vcs)[[:space:]]*=' \
  ...
  crates/ctx-history-capture-model/Cargo.toml \
  crates/ctx-history-source-discovery/Cargo.toml \
  crates/ctx-history-source-io/Cargo.toml \
  crates/ctx-history-source-sqlite/Cargo.toml \
  crates/ctx-history-providers-sqlite-logical/Cargo.toml \
  crates/ctx-history-core/Cargo.toml \
  crates/ctx-history-index-format/Cargo.toml \
  ...
  crates/ctx-history-read-application/Cargo.toml \
...
if ! grep -Fxq 'tantivy.workspace = true' crates/ctx-history-index/Cargo.toml \
  || ! grep -Fxq 'tantivy.workspace = true' crates/ctx-history-index-format/Cargo.toml \
  || ! grep -Fxq 'tantivy.workspace = true' crates/ctx-history-index-generation/Cargo.toml \
  || ! grep -Fxq 'tantivy.workspace = true' crates/ctx-history-index-query/Cargo.toml; then
