...
pub use upgrade::{
    ...
    managed_install_marker_for_current_exe, path_diagnostics, read_state_json,
    run_hosted_transaction, terminal_installation_upgrade_attempt_id, upgrade_diagnostics,
    AutomaticUpgradeObservation, AutomaticUpgradePolicyProvider, AutomaticUpgradePolicySnapshot,
    BackgroundApplyBlockReason, DaemonRestart, DaemonUpgradeLease, DaemonUpgradePort,
    HostedTransactionAction, HostedTransactionArgs, InstallMarker, ManagedInstallDiagnostic,
    ManagedInstallMarker, PathDiagnosticEntry, PathDiagnostics, PathResolverStatus,
    PreparedDaemonUpgrade, ProductBuildIdentity, ReleaseProcessPort, ReleaseTransport,
    ...
    UpgradePlan, UpgradePolicy, UpgradeTerminalStatus, STATE_SCHEMA_VERSION,
};
