...
use ctx_history_index_format::{is_generation_id, EventRangeOrderKey};

const EVENT_RANGE_CURSOR_VERSION: u8 = 2;
const EVENT_RANGE_CURSOR_BYTES: usize =
    1 + 64 + 32 + ctx_history_index_format::EVENT_RANGE_ORDER_KEY_LEN + 32;
...
use term_merger::{OrderedTermMerger, ReverseTermMerger};
...
impl CoreEventRangeCursor {
    ...
    #[doc(hidden)]
    pub fn test_after(&self) -> EventRangeOrderKey {
        self.after
    }

    #[cfg(any(test, feature = "test-support"))]
    #[doc(hidden)]
    pub fn test_set_after(&mut self, after: EventRangeOrderKey) {
        self.after = after;
    }
