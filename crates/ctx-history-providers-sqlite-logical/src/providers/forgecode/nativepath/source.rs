...
pub(in crate::providers::forgecode) struct ForgeCodeFrontier {
    pub(in crate::providers::forgecode) rowid: Option<i64>,
    pub(in crate::providers::forgecode) next_message: u32,
    pub(in crate::providers::forgecode) row_complete: bool,
}

impl ForgeCodeFrontier {
    pub(in crate::providers::forgecode) const fn initial() -> Self {
        Self {
            rowid: None,
            next_message: 0,
            row_complete: true,
...
#[derive(Clone)]
pub(in crate::providers::forgecode) struct ForgeCodeSourceObservation {
...
pub(in crate::providers::forgecode) enum ForgeCodeDiscovery {
    Live(ForgeCodeSourceObservation),
    Missing,
}

pub(in crate::providers::forgecode) fn discover_forgecode_source(
    data_root: &Path,
    path: &Path,
...
#[derive(Debug)]
pub(in crate::providers::forgecode) struct ForgeCodeSqliteDatabase {
...
pub(in crate::providers::forgecode) struct ForgeCodeScanner {
...
#[derive(Debug)]
pub(in crate::providers::forgecode) struct ForgeCodePage {
    ...
    #[allow(dead_code)]
    pub(in crate::providers::forgecode) expected_frontier: ForgeCodeFrontier,
    pub(in crate::providers::forgecode) next_frontier: ForgeCodeFrontier,
...
#[derive(Debug)]
pub(in crate::providers::forgecode) struct ForgeCodeRetainedEvent {
    pub(in crate::providers::forgecode) event: ForgeCodeNativeEvent,
    pub(in crate::providers::forgecode) provider_event_index: u64,
}

#[derive(Debug, Clone)]
pub(in crate::providers::forgecode) struct ForgeCodeConversationRow {
    pub(in crate::providers::forgecode) rowid: i64,
    pub(in crate::providers::forgecode) source_record_digest: [u8; 32],
    pub(in crate::providers::forgecode) canonical_record_bytes: u64,
    pub(in crate::providers::forgecode) conversation_id: String,
    pub(in crate::providers::forgecode) title: Option<String>,
    pub(in crate::providers::forgecode) workspace_id: i64,
    pub(in crate::providers::forgecode) created_at: String,
    pub(in crate::providers::forgecode) updated_at: Option<String>,
    pub(in crate::providers::forgecode) context_metadata: Value,
    pub(in crate::providers::forgecode) metrics_metadata: Option<Value>,
}
