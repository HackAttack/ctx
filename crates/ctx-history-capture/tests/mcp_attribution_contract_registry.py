...
ROUTE_SCHEMA_CONTRACTS = (
    ...
    RouteSchemaContract(
        provider="openhands",
        route="native_import",
        source_format="openhands_cli_file_events",
        format_schema=_structural(1),
        producer_domain=_discrete(_unversioned(1)),
        path="crates/ctx-history-capture/tests/contracts/mcp-attribution/openhands/openhands_cli_file_events/shape-contract.json",
        allowed_subtree="crates/ctx-history-capture/tests/contracts/mcp-attribution/openhands/openhands_cli_file_events",
        classification=ROUTE_CONTRACT_CLASSIFICATION,
        sha256="98c47e2fd209761bedb0495ddb3c6976458e0c7077f0b6af3bf89b4a844ae494",
    ),
    RouteSchemaContract(
    ...
    RouteSchemaContract(
        ...
        format_schema=_structural(1),
        producer_domain=_discrete(_unversioned(1)),
        path="crates/ctx-history-capture/tests/contracts/mcp-attribution/cline/cline_sdk_session_store/shape-contract.json",
        allowed_subtree="crates/ctx-history-capture/tests/contracts/mcp-attribution/cline/cline_sdk_session_store",
        classification=ROUTE_CONTRACT_CLASSIFICATION,
        sha256="2fcc5b29ba2ba0973c94e2291bc093e495ba232ca0b532535aad5c3f0cdaa15a",
    ),
    RouteSchemaContract(
        provider="cline",
        route="native_import",
