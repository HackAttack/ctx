...
use crate::{
    ...
    CaptureError, Result, MAX_PROVIDER_JSONL_LINE_BYTES, PROVIDER_JSONL_INVENTORY_MAX_DEPTH,
...
impl JsonlFamilyAdapter for DeepSeekHarnessJsonlAdapter {
    ...
    fn semantic_executor(
        ...
        Ok(Some(Box::new(DeepSeekHarnessSemanticExecutor::new(
            leaf.source().clone(),
...
struct DeepSeekHarnessSemanticExecutor {
    source: SourceKey,
...
impl DeepSeekHarnessSemanticExecutor {
    fn new(
        source: SourceKey,
        source_selector: PathBuf,
        binding: SessionHeader,
